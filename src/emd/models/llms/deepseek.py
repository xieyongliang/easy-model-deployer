...
from ..engines import (
    ...
    ktransformers_r1_engine,
    ktransformers_v3_engine,
)
...
Model.register(
    dict(
        ...
        supported_engines=[llama_cpp_deepseek_r1_1d58_bit_engine_b9ab0a4, ktransformers_r1_engine],
        supported_instances=[
            g5d8xlarge_instance,
            g5d12xlarge_instance,
            g5d16xlarge_instance,
...
Model.register(
    dict(
        ...
        supported_engines=[ktransformers_r1_engine],
        supported_instances=[
            g5d12xlarge_instance,
            g5d16xlarge_instance,
            g5d24xlarge_instance,
...
Model.register(
    dict(
        model_id = "deepseek-v3-0324-671b-1.58bit_gguf",
        supported_engines=[llama_cpp_deepseek_r1_1d58_bit_engine_b9ab0a4, ktransformers_v3_engine],
        supported_instances=[
            g5d8xlarge_instance,
            g5d12xlarge_instance,
            g5d16xlarge_instance,
        ...
        allow_china_region=True,
        need_prepare_model=False,
        huggingface_model_id="unsloth/DeepSeek-V3-0324-GGUF",
        huggingface_model_download_kwargs = dict(allow_patterns = ["*UD-IQ1_S*"]),
        modelscope_model_id="unsloth/DeepSeek-V3-0324-GGUF",
        require_huggingface_token=False,
        application_scenario="Agent, tool use, translation, summary",
        description="The latest series of DeepSeek LLMs for reasoning",
        model_type=ModelType.LLM,
...
Model.register(
    dict(
        model_id = "deepseek-v3-0324-671b-2.51bit_gguf",
        supported_engines=[ktransformers_v3_engine],
        supported_instances=[
            g5d12xlarge_instance,
            g5d16xlarge_instance,
            g5d24xlarge_instance,
...
Model.register(
    dict(
        model_id = "deepseek-v3-0324-671b-4bit_gguf",
        supported_engines=[ktransformers_v3_engine],
        supported_instances=[
            g5d24xlarge_instance,
            g5d48xlarge_instance,
