...
class KTransformersCppBackend(OpenAICompitableProxyBackendBase):
    ...
    def create_proxy_server_start_command(self,model_path):
        ...
        # compute_compability: g5 - 8.6, g6 - 8.9
        TORCH_CUDA_ARCH_LIST = '8.6' if self.instance_type.contains('g5') else '8.9'
        cpu_infer = 94 if self.instance_type.contains('24xlarge') else 62
        max_new_tokens = 2048
